		...
		<body>
			...
			<div id="replyArea" style="margin-top:30px; border-top:1px solid #ddd; padding-top:20px;">
				...
				<div id="replyWriteArea" style="margin-bottom:15px;">
					<textarea id="replyContent" maxlength="1000" placeholder="댓글을 입력하세요."
			...
			<div id="likeModal"
				style="display:none; position:fixed; left:0; top:0; width:100%; height:100%; background:rgba(0,0,0,0.4); z-index:9999;">
				<div style="
				background:white;
				width:350px;
				max-width: 90%;
				...
				<script>
					...
					$(document).ready(function () {
						...
						$("#btnList").on("click", function () {
							let listUrl = '/?page=' + page + '&searchType=' + searchType + '&keyword=' + keyword + '&sortType=' + sortType;

							if (boardGroupIdx) {
								listUrl += '&boardGroupIdx=' + boardGroupIdx;
							}
						...
						$.ajax({
							...
							success: function (response) {
								...
								if (response.auth === true || response.isAuth === true) {
									let editUrl = '/board/update?idx=' + idx + '&page=' + page + '&searchType=' + searchType + '&keyword=' + keyword + '&sortType=' + sortType;
									if (boardGroupIdx) {
										editUrl += '&boardGroupIdx=' + boardGroupIdx;
									}
									let btnHtml = '<button onclick="location.href=\'' + editUrl + '\'">수정</button>' +
